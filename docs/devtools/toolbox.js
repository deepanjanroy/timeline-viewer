...
return{added:added,removed:removed,equal:equal};};;Node.prototype.rangeOfWord=function(offset,stopCharacters,stayWithinNode,direction){var startNode;var startOffset=0;var endNode;var endOffset=0;if(!stayWithinNode)
...
parent=parent.parentNode;return parent instanceof ShadowRoot?parent.getSelection():this.window().getSelection();};Node.prototype.isComponentSelectionCollapsed=function(){var selection=this.getComponentSelection();var range=selection&&selection.rangeCount?selection.getRangeAt(0):null;return range?range.collapsed:true;};Node.prototype.hasSelection=function(){if(this.isComponentSelectionCollapsed())
...
function runOnWindowLoad(callback){if(window.uglyGlobals&&window.uglyGlobals.globalsReady)callback();window.uglyGlobals=window.uglyGlobals||{};window.uglyGlobals.runOnWindowLoad=window.uglyGlobals.runOnWindowLoad||[];window.uglyGlobals.runOnWindowLoad.push(callback);};self['ToolboxBootstrap']=self['ToolboxBootstrap']||{};(function(){function toolboxLoaded(){if(!window.opener)
