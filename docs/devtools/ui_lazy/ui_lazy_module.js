...
this._scrollContainer.scrollTop=scrollTop;}};UI.ViewportDataGrid.Events={ViewportCalculated:Symbol('ViewportCalculated')};UI.ViewportDataGridNode=class extends UI.DataGridNode{constructor(data,hasChildren){super(data,hasChildren);this._stale=false;this._flatNodes=null;}
...
context.restore();const headerHeight=15;UI.TimelineGrid.drawCanvasGrid(context,this._calculator,3,headerHeight);this._drawMarkers();this._drawGroupHeaders(width,height);this._updateElementPosition(this._highlightElement,this._highlightedEntryIndex);this._updateElementPosition(this._selectedElement,this._selectedEntryIndex);this._updateMarkerHighlight();}
_drawGroupHeaders(width,height){var context=(this._canvas.getContext('2d'));var top=this.getScrollOffset();var ratio=window.devicePixelRatio;var barHeight=this._barHeight;var textBaseHeight=barHeight-this._dataProvider.textBaseline();var groups=this._rawTimelineData.groups||[];if(!groups.length)
...
_enabled(){return this._rawTimelineDataLength!==0;}};UI.FlameChart.DividersBarHeight=18;UI.FlameChart.MinimalTimeWindowMs=0.5;UI.FlameChartDataProvider=function(){};UI.FlameChart.Group;UI.FlameChart.GroupStyle;UI.FlameChart.TimelineData=class{constructor(entryLevels,entryTotalTimes,entryStartTimes,groups){this.entryLevels=entryLevels;this.entryTotalTimes=entryTotalTimes;this.entryStartTimes=entryStartTimes;this.groups=groups;this.markers=[];}};UI.FlameChartDataProvider.prototype={barHeight(){},minimumBoundary(){},totalTime(){},formatValue(value,precision){},maxStackDepth(){},timelineData(){},prepareHighlightedEntryInfo(entryIndex){},canJumpToEntry(entryIndex){},entryTitle(entryIndex){},entryFont(entryIndex){},entryColor(entryIndex){},decorateEntry(entryIndex,context,text,barX,barY,barWidth,barHeight,unclippedBarX,timeToPixels){},forceDecoration(entryIndex){},textColor(entryIndex){},textBaseline(){},textPadding(){},paddingLeft(){},};UI.FlameChartMarker=function(){};UI.FlameChartMarker.prototype={startTime(){},color(){},title(){},draw(context,x,height,pixelsPerMillisecond){},};UI.FlameChart.Events={EntrySelected:Symbol('EntrySelected')};UI.FlameChart.ColorGenerator=class{constructor(hueSpace,satSpace,lightnessSpace,alphaSpace){this._hueSpace=hueSpace||{min:0,max:360};this._satSpace=satSpace||67;this._lightnessSpace=lightnessSpace||80;this._alphaSpace=alphaSpace||1;this._colors=new Map();}
...
boundarySpan(){return this._maximumBoundary-this._minimumBoundary;}};UI.TimelineOverview=function(){};UI.TimelineOverview.prototype={show(parentElement,insertBefore){},update(){},dispose(){},reset(){},popoverElementPromise(x){},onClick(event){},windowTimes(windowLeft,windowRight){},windowBoundaries(startTime,endTime){},timelineStarted(){},timelineStopped(){},};UI.TimelineOverviewBase=class extends UI.VBox{constructor(){super();this._calculator=null;this._canvas=this.element.createChild('canvas','fill');this._context=this._canvas.getContext('2d');}
