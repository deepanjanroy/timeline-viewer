var allDescriptors=[{"skip_compilation":["gonzales-scss.js"],"dependencies":["formatter_worker"],"extensions":[{"className":"Gonzales.SCSSParser","mimeType":"text/x-scss","type":"@FormatterWorker.FormatterWorkerContentParser"}],"name":"gonzales","scripts":["gonzales_module.js"]},{"skip_compilation":["acorn/acorn.js","../cm/headlesscodemirror.js","../cm/css.js","../cm/xml.js"],"name":"formatter_worker"}];var applicationDescriptor;var _loadedScripts={};for(var k of[]){}
...
ServicePort.prototype={setHandlers(messageHandler,closeHandler){},send(message){},close(){}};var runtime;self['FormatterWorker']=self['FormatterWorker']||{};var ArrayLike;function mod(m,n){return((m%n)+n)%n;}
...
CodeMirror.defineMIME("text/html",{name:"xml",htmlMode:true});});;self['Common']=self['Common']||{};Common.Text=class{constructor(value){this._value=value;}
...
newRange(){return Common.TextRange.fromEdit(this.oldRange,this.newText);}};;FormatterWorker.ESTreeWalker=class{constructor(beforeVisit,afterVisit){this._beforeVisit=beforeVisit;this._afterVisit=afterVisit||new Function();this._walkNulls=false;}
...
value=-(value);}
return value;}};FormatterWorker.RelaxedJSONParser.Context;;applicationDescriptor={"has_html":false,"modules":[{"type":"remote","name":"gonzales"},{"type":"autostart","name":"formatter_worker"}]};if(!self.Runtime)
